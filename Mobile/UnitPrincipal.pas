...
begin
  AddMensagem(0, 'Igor Pereira', '19/10/2023', 'Isso é um teste de mensagem', 20, 10);
  AddMensagem(0, 'Marcela Cardoso', '19/10/2023', 'Isso é um teste de mensagem', 2800, 1034);
  AddMensagem(0, 'Pedro Igor', '19/10/2023', 'Isso é um teste de mensagem', 20, 10);
  AddMensagem(0, 'Igor Pereira', '19/10/2023', 'Isso é um teste de mensagem', 20, 10);
  AddMensagem(0, 'Igor Pereira', '19/10/2023', 'Isso é um teste de mensagem', 20, 10);
end;
...
begin
  AddBoletim('Matemática', 10, 1);
  AddBoletim('Física', 9.2, 3);
  AddBoletim('Química', 8.9, 0);
  AddBoletim('Biologia', 9.5, 2);
  AddBoletim('Português', 10, 2);
end;
...
begin
  ...
  lvCalendario.Items.Clear;
  AddCalendario('Reunião de pais e mestres', '10:00');
  AddCalendario('Reunião de pais e mestres', '10:00');
  AddCalendario('Reunião de pais e mestres', '10:00');
  AddCalendario('Reunião de pais e mestres', '10:00');
end;
